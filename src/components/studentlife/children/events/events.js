						...
						<div className="col-sm-3">
							<div className="card">
								<div className="card-body">
									<h4 className="card-title"> {{event.title}}</h4> <a href="{{event.events}}" className="btn btn-primary" target="_blank"> Details <i className="fa fa-angle-double-right"></i> </a> </div>
							</div>
						</div>
					</div>
				</div> */}
						...
						<div className="row section-content">
							<div className="col-lg-8">
								<div className="blog-detail-content pb20">
									...
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img.jpg" alt="image" /> </div>
									<hr></hr>
									<h3 className="trust__heading">ROBO SOCCER  </h3>
									...
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img1.jpg" alt="image" /> </div>
									<hr></hr>
									<h3 className="trust__heading">TECHN OCHAMP  </h3>
									...
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img2.jpg" alt="image" /> </div>
									<hr></hr>
									...
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img3.jpg" alt="image" /> </div>
									<hr></hr>
									...
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img4.jpg" alt="image" /> </div>
									<hr></hr>
									...
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img5.jpg" alt="image" /> </div>
									<hr></hr>
									...
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img6.jpg" alt="image" /> </div>
									<hr></hr>
									...
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img7.jpg" alt="image" /> </div>
									<hr></hr>
									<h3 className="trust__heading">Workshop on   Android Development  </h3>
									...
									<p></p>
									<p className="mb-4"> EVENT DESCRIPTION: A theme was given toevery participant. Every participant had to capture their clicks within 2 hours and some of the participants edited their captures in the given time. A platform (Photoshop) was provided. </p>
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img8.jpg" alt="image" /> </div> <u>National Conference on Computing, Informatics and Networks NCCIN-2K18 </u>
									...
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img10.jpg" alt="image" /> </div>
									<hr></hr>
									...
									<div className="w-100 pull-left">
										<div className="row">
											<div className="col-lg"> <img className="people-image center-h" src="/assets/images/student_life_event_img11.jpg" alt="image" />
												<br></br>
									...
									<div className="cluUpper"> <strong className="mb-2 pull-left w-100">TEACHERS DAY</strong>
										<div className="w-100 pull-left">
											<div className="row">
												<div className="col-lg"> <img className="people-image center-h" src="/assets/images/cultucher240.jpg" alt="image" />
													<br></br>
									...
									<div className="cluUpper"> <strong className="mb-2 pull-left w-100">INDEPENDENCE DAY</strong>
										<div className="w-100 pull-left">
											<div className="row">
												<div className="col-lg"> <img className="people-image center-h" src="/assets/images/cultucher241.jpg" alt="image" />
													<br></br>
									...
									<div className="cluUpper"> <strong className="mb-2 pull-left w-100">HOLI MILAN</strong>
										<div className="w-100 pull-left">
											<div className="row">
												<div className="col-lg"> <img className="people-image center-h" src="/assets/images/cultucher242.jpg" alt="image" />
													<br></br>
									...
									<div className="cluUpper"> <strong className="mb-2 pull-left w-100">CORONA</strong>
										<div className="w-100 pull-left">
											<div className="row">
												<div className="col-lg"> <img className="people-image center-h" src="/assets/images/cultucher243.jpg" alt="image" />
													<br></br>
									...
									<div className="cluUpper"> <strong className="mb-2 pull-left w-100">ELOQUENCE</strong>
										<div className="w-100 pull-left">
											<div className="row">
												<div className="col-lg"> <img className="people-image center-h" src="/assets/images/cultucher244.jpg" alt="image" />
													<br></br>
