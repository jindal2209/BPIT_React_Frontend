						...
						<div className="row section-content">
							<div className="col-lg-8">
								<div className="blog-detail-content pb20">
									...
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img.jpg" alt="" /> </div>
									<hr></hr>
									...
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img1.jpg" alt="" /> </div>
									<hr></hr>
									...
									<p></p>
									<p className="mb-4"> EVENT DESCRIPTION: A theme was given toevery participant. Every participant had to capture their clicks within 2 hours and some of the participants edited their captures in the given time. A platform (Photoshop) was provided. </p>
									<div className="blog-detail-pic pb30"> <img className="people-image center-h" src="/assets/images/student_life_event_img8.jpg" alt="" /> </div> <u>National Conference on Computing, Informatics and Networks NCCIN-2K18 </u>
									...
									<div className="cluUpper"> <strong className="mb-2 pull-left w-100">TEACHERS DAY</strong>
										<div className="w-100 pull-left">
											<div className="row">
												<div className="col-lg"> <img className="people-image center-h" src="/assets/images/cultucher240.jpg" alt="" />
													<br></br>
									...
									<div className="cluUpper"> <strong className="mb-2 pull-left w-100">INDEPENDENCE DAY</strong>
										<div className="w-100 pull-left">
											<div className="row">
												<div className="col-lg"> <img className="people-image center-h" src="/assets/images/cultucher241.jpg" alt="" />
													<br></br>
									...
									<div className="cluUpper"> <strong className="mb-2 pull-left w-100">HOLI MILAN</strong>
										<div className="w-100 pull-left">
											<div className="row">
												<div className="col-lg"> <img className="people-image center-h" src="/assets/images/cultucher242.jpg" alt="" />
													<br></br>
									...
									<div className="cluUpper"> <strong className="mb-2 pull-left w-100">CORONA</strong>
										<div className="w-100 pull-left">
											<div className="row">
												<div className="col-lg"> <img className="people-image center-h" src="/assets/images/cultucher243.jpg" alt="" />
													<br></br>
									...
									<div className="cluUpper"> <strong className="mb-2 pull-left w-100">ELOQUENCE</strong>
										<div className="w-100 pull-left">
											<div className="row">
												<div className="col-lg"> <img className="people-image center-h" src="/assets/images/cultucher244.jpg" alt="" />
													<br></br>
