	...
	return(
		<Fragment>
			<div id="add-animation">
				...
				<img src={process.env.PUBLIC_URL+"/assets/images/aicte.jpg"} className="people-image center-h" alt="" />
				<p id="text-content">
				...
				<img src={process.env.PUBLIC_URL+"/assets/images/nba.png"} className="people-image center-h" alt="" />
