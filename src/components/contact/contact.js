	...
	return(
		<React.Fragment>
			<div className="container-fluid m-5 p-5">
				...
				<hr></hr>
				<div className="page-body font-weight-bold">
					<h1 className="font-weight-bold">BHAGWAN PARSHURAM INSTITUTE OF TECHNOLOGY</h1>
